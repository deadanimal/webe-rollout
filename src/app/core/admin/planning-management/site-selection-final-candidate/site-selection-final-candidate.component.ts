...
import * as SiteSelections from "src/app/variables/site-selections";
...
@Component({
  selector: "app-site-selection-final-candidate",
  templateUrl: "./site-selection-final-candidate.component.html",
  styleUrls: ["./site-selection-final-candidate.component.scss"]
})
export class SiteSelectionFinalCandidateComponent implements OnInit {
  entries: number = 5;
  selected: any[] = [];
  temp = [];
  activeRow: any;
  rows = SiteSelections.SiteSelections;
  ...
  leafletOptions = {
    layers: [
      ...
      L.circle([ 2.940298, 101.47522 ], { radius: 10000 }),
      L.circle([ 3.196735, 101.431274 ], { radius: 10000 }),
      L.circle([ 3.126804, 101.862488 ], { radius: 10000 })
    ],
    zoom: 9,
