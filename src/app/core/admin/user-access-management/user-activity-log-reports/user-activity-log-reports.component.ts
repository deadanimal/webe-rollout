...
@Component({
  selector: "app-user-activity-log-reports",
  templateUrl: "./user-activity-log-reports.component.html",
  styleUrls: ["./user-activity-log-reports.component.scss"]
})
export class UserActivityLogReportsComponent implements OnInit {
  entries: number = 5;
  selected: any[] = [];
  temp = [];
  activeRow: any;
