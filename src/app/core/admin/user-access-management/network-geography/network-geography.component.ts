...
import * as NetworkGeographys from "src/app/variables/network-geographys";
...
@Component({
  selector: "app-network-geography",
  templateUrl: "./network-geography.component.html",
  styleUrls: ["./network-geography.component.scss"]
})
export class NetworkGeographyComponent implements OnInit {
  entries: number = 5;
  selected: any[] = [];
  temp = [];
  activeRow: any;
  rows = NetworkGeographys.NetworkGeographys;
  SelectionType = SelectionType;

  // dropdowns
  areas = ["rural", "city", "village"];
  regions = ["northern", "eastern", "western", "southern"];
  states = ["johor", "kedah", "kelantan", "melaka", "negeri sembilan"];
  districts = ["segamat", "alor setar", "kota bharu", "ayer keroh", "seremban"];
  majliss = ["MPS", "MPAS", "MPKB", "MPAK", "MPS"];
