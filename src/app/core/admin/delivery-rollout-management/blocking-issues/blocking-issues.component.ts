...
@Component({
  selector: "app-blocking-issues",
  templateUrl: "./blocking-issues.component.html",
  styleUrls: ["./blocking-issues.component.scss"]
})
export class BlockingIssuesComponent implements OnInit {
  entries: number = 5;
  selected: any[] = [];
  temp = [];
  activeRow: any;
