...
@Component({
  selector: "app-punchlist-management",
  templateUrl: "./punchlist-management.component.html",
  styleUrls: ["./punchlist-management.component.scss"]
})
export class PunchlistManagementComponent implements OnInit {
  entries: number = 5;
  selected: any[] = [];
  temp = [];
  activeRow: any;
