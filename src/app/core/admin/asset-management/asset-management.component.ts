...
import * as AssetManagements from "src/app/variables/asset-managements";
...
export class AssetManagementComponent implements OnInit {
  ...
  temp = [];
  activeRow: any;
  rows = AssetManagements.AssetManagements;
  ...
  resetTable() {
    ...
    this.searchInput.partid = "";
    this.searchInput.name = "";
    this.searchInput.category = "";
    this.searchInput.vendor = "";
  }
