...
import * as Customers from "src/app/variables/customers";
...
export class ReportComponent implements OnInit {
  ...
  resetTable() {
    ...
    this.searchInput.customername = "";
    this.searchInput.type = "";
    this.searchInput.email = "";
    this.searchInput.accountnumber = "";
  }
  ...
  editCustomer(row, content) {
    this.formInput = row;
    this.open(content, "modal-mini", "sm", "Edit Customer");
  }
